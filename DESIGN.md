...
description: An inspired interpretation of Wise's design language adapted for this AML risk product, using OPPO Sans globally with vivid lime-green brand accents, sage-tinted surface neutrals, strong contrast, and rounded cards on a pale green-tinted canvas.
fontAsset: /fonts/oppo-sans-4.0.ttf
implementationNote: Frontend CSS must load OPPO Sans from apps/web/public/fonts/oppo-sans-4.0.ttf and use it as the global sans-serif font.
...
typography:
  display-mega:
    fontFamily: OPPO Sans, Inter, system-ui, -apple-system, sans-serif
    fontSize: 126px
    fontWeight: 900
    lineHeight: 107.1px
  display-xxl:
    fontFamily: OPPO Sans, Inter, system-ui, sans-serif
    fontSize: 96px
    fontWeight: 900
    lineHeight: 81.6px
  display-xl:
